...
log.info(' ___      __   __  ___   _  _______  __    _  _______  ______   _______ ');
log.info('|   |    |  | |  ||   | | ||       ||  |  | ||       ||      | |       |');
log.info('|   |    |  | |  ||   |_| ||    ___||   |_| ||   _   ||  _    ||    ___|');
log.info('|   |    |  |_|  ||      _||   |___ |       ||  | |  || | |   ||   |___ ');
log.info('|   |___ |       ||     |_ |    ___||  _    ||  |_|  || |_|   ||    ___|');
log.info('|       ||       ||    _  ||   |___ | | |   ||       ||       ||   |___ ');
log.info('|_______||_______||___| |_||_______||_|  |__||_______||______| |_______|');

log.info('======================================================');
log.info(`             LukeNode v Operation Get the TRAC`);
log.info('======================================================');
log.info('');
